    ...
    <Layout>
      ...
      <section className="bg-white p-6 shadow-xl">
        ...
        <p>
          ...
          keep it for themselves. The world's entire scientific and
        ...
        <p>
          ...
          for access, and it's perfectly legal - there's nothing we
          can do to stop them." But there is something we can, something
        ...
        <p>
          ...
          its crew. But sharing isn't immoral - it's a moral
          imperative. Only those blinded by greed would refuse to let a friend
          make a copy.`}
        </p>
        ...
        <p>
          ...
          and share them with the world. We need to take stuff that's out
          of copyright and add it to the archive. We need to buy secret
